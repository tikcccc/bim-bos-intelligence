...
export async function routeIntent(
  ...
  return postAI<IntentResponse & { functionCalls?: any[] }>("route-intent", { message, userContext, memory });
}
...
export async function generateProactiveAlerts(
  ...
  return postAI<ProactiveAlert[]>("generate-proactive-alerts", { userContext, businessCache });
}
